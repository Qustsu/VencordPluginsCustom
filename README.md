# Vencord Fork - Custom Plugins

> Это форк [Vencord](https://github.com/Vendicated/Vencord) с кастомными плагинами

## Оригинальный Vencord

**Оригинальный репозиторий:** https://github.com/Vendicated/Vencord
